  ...
  return (
    <div className="grid grid-rows-[auto_1fr] w-screen min-h-screen">
      <div className="w-full flex flex-row justify-center border border-b-foreground/10 bg-background sticky top-0 left-0">
        <header className="container py-4 flex flex-row justify-between items-center px-6">
          <h1 className="font-semibold">
            <span className="text-sm font-normal opacity-50 hidden sm:inline">
              <a href="https://github.com/iyxan23">iyxan23</a> /{" "}
            </span>
            <a href="https://github.com/iyxan23/ooxml-templater-js">
              ooxml-templater-js
            </a>{" "}
            <div className="hidden sm:inline"><DemoText /></div>
          </h1>
          <div className="flex flex-row gap-4 sm:gap-8 items-center">
            <nav className="flex flex-row gap-4 sm:gap-6 items-center text-sm font-medium">
              <NavigationLink to="/" text="home" />
              <NavigationLink to="/docx" text="docx" />
              <NavigationLink to="/xlsx" text="xlsx" />
            </nav>
            <div className="h-full w-[1px] bg-foreground/20 hidden sm:block">&nbsp;</div>
            <ModeToggle />
          </div>
        </header>
      </div>
